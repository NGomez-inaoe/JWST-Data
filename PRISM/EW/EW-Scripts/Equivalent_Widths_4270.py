...
A_region = SpectralRegion(3650 *u.AA, 4380 *u.AA)
B_region = SpectralRegion(4800 *u.AA, 5070 *u.AA)
C_region = SpectralRegion(6500 *u.AA, 6750 *u.AA)
D_region = SpectralRegion(9040 *u.AA, 9090 *u.AA)
E_region = SpectralRegion(9490 *u.AA, 9570 *u.AA)
