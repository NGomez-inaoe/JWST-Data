"""Basic Functionalities of specutils to compute equivalent width. Uncertainties are not included in this version"""
...
def main():
    ...
    EWD.to_csv("EW_output_v2.tsv", sep="\t", index=False)
...
def compare_EW(mast_file, jades_file, z, printValue=False):
    ...
    with fits.open(mast_file) as m_f:
        ...
        with warnings.catch_warnings(): #ignore warnings
            ...
            Lower_lamb_region = SpectralRegion(lamb[0], 2200 * u.AA)
