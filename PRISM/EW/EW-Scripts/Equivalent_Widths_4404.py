...
A_region = SpectralRegion(3600 *u.AA, 4385 *u.AA)
B_region = SpectralRegion(4825 *u.AA, 5050 *u.AA)
C_region = SpectralRegion(6530 *u.AA, 6590 *u.AA)
...
def main():
    ...
    EWD.to_csv(f'{output_folder}/EW_output_v5.tsv', sep="\t", index=False, mode='a')
