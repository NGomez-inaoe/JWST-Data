...
def compare_EW(mast_file, jades_file, z, printValue=False):
    ...
    with fits.open(mast_file) as m_f:
        ...
        with warnings.catch_warnings(): #ignore warnings
            ...
            spec_continuum_fitted = fit_generic_continuum(mast_spectrum, exclude_regions=[Lower_lamb_region, lines_regions, Last_lamb_region])(mast_spectrum.spectral_axis)
    ...
    with fits.open(jades_file) as j_f:
        ...
        with warnings.catch_warnings(): #ignore warnings
            ...
            lines_regions = SpectralRegion(4740 * u.AA, 6780 * u.AA )
                #Compute continuum by fitting
            spec_continuum_fitted = fit_generic_continuum(jades_spectrum, exclude_regions=[Lower_lamb_region, lines_regions, Last_lamb_region])(jades_spectrum.spectral_axis)
