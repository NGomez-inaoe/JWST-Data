...
#//////////////////////////////////////
indx=0
lines_bR_df = pd.read_csv(f'./Line_Regions_by_z.tsv', sep='\t')
lines_df = pd.read_csv(f'{output_folder}/EW_output_v6_1.tsv', sep='\t')
z = z_array[indx]

if z > 3:
  Ha_ini = lines_bR_df["Ha_ini"][2] *u.AA
  Ha_end = lines_df["Ha_end"][indx] *u.AA
  Hb_ini = lines_df["Hb_ini"][indx] *u.AA
  Hb_end = lines_df["Hb_end"][indx] *u.AA
  O_ini = lines_df["[OIII]_ini"][indx] *u.AA
  O_end = lines_df["[OIII]_end"][indx] *u.AA

else:
  Ha_ini = lines_df["Ha_ini"][indx] *u.AA
  Ha_end = lines_df["Ha_end"][indx] *u.AA
  Hb_ini = lines_df["Hb_ini"][indx] *u.AA
  Hb_end = lines_df["Hb_end"][indx] *u.AA
  O_ini = lines_df["[OIII]_ini"][indx] *u.AA
