...
prism_file_jades = Path('/home/nicolas/Documents/Research/PhD/JWST-Data/PRISM/Spectra1D/JADES/hlsp_jades_jwst_nirspec_goods-s-deephst-00008113_clear-prism_v1.0_x1d.fits')
prism_file_mast = Path('/home/nicolas/Documents/Research/PhD/JWST-Data/PRISM/Spectra1D/MAST/jw01210-o001_s000013846_nirspec_clear-prism_x1d.fits')
g395h_file_jades = Path('/home/nicolas/Documents/Research/PhD/JWST-Data/High_Resolution/Spectra1D/JADES/hlsp_jades_jwst_nirspec_goods-s-deephst-00008113_f290lp-g395h_v1.0_x1d.fits')
g395h_file_mast = Path('/home/nicolas/Documents/Research/PhD/JWST-Data/High_Resolution/Spectra1D/MAST/jw01210-o001_s000013846_nirspec_f290lp-g395h_x1d.fits')
...
def main():
    ...
    jades_prism, mast_prism = flux_prism()
    jades_g395h, mast_g395h = flux_g395h()
    
    Hbeta_prism, Hbeta_prism_unc, O3_prism, O3_prism_unc = jades_prism
    O5007_g395h, O5007_g395h_unc, O4959_g395h, O4959_g395h_unc = jades_g395h
    ...
    O5007_g395h, O5007_g395h_unc, O4959_g395h, O4959_g395h_unc = mast_g395h
...
def flux_prism():
    ...
    with fits.open(prism_file_jades) as f:
        ...
        with fits.open(prism_file_mast) as f:
            specdata = f[1].data
            ...
            mast_fluxes = get_line_fluxes_prism(lambda_rest, flux)


    
    return jades_fluxes, mast_fluxes
#------------------------------------------------------------------------
#=======================================================================
#------------------------------------------------------------------------
def get_line_fluxes_g395h(lambda_rest, flux):

     #Arrays for the lines
    
    O4959_region = [4957, 4966] 
    O5007_region = [5002, 5012]
    ...
    O4959_flux, O4959_flux_unc = compute_line_flux(lambda_rest_AA, flux_Jy, O4959_region, z, 'G395H')
    O5007_flux, O5007_flux_unc = compute_line_flux(lambda_rest_AA, flux_Jy, O5007_region, z, 'G395H')
...
def flux_g395h():
    ...
    with fits.open(g395h_file_jades) as f:
        specdata = f[1].data
        ...
        jades_fluxes = get_line_fluxes_g395h(lambda_rest, flux) 

        with fits.open(g395h_file_mast) as f:
            specdata = f[1].data
            ...
            mast_fluxes = get_line_fluxes_g395h(lambda_rest, flux)
