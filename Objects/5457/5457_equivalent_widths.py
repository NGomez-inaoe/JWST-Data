...
output_folder=source / "Objects/5457"
...
Ha_ini, Ha_end = 6531 *u.AA, 6594 *u.AA
Hb_ini, Hb_end = 4828 *u.AA, 4891 *u.AA
O_ini, O_end = 4931 *u.AA, 5064 *u.AA
#//////////////////////////////////////
...
def main():
  ...
  #EWD.to_csv(f'{output_folder}/EW_output.tsv', sep="\t", index=False, mode='a', header=False)
